        ...
        protected void LoadPersonalInfo(string empid)
        {
            try
            {
                ...
                string query = "select Empstatus,EmpId,Title,EmpFName,EmpMName,EmpLName,EmpSex,EmpMaritalStatus,EmpDtofBirth,EmpQualification,EmpDesgn,EmpFatherName,EmpFatherOccupation,EmpSpouseName,EmpMotherName,EmpDtofInterview,EmpDtofJoining," +
                    ...
                    "prState,isnull(C2.City,0) as prCity,prphone,EmpPresentAddress,peState,isnull(C.City,0) as peCity,pephone,prPostoffice,prLmark,prPincode,pePostoffice,peLmark,pepincode, empbankname,empbankacno,Empbankbranchname,empifsccode,empbranchcode,empbankcode," +
                    ...
                    " FoodAllowance,isnull(Oldempid,'') as Oldempid,prResidingDate,prperiodofstay,ResidingDate,periodofstay,EmployeeType,EmpSign,EmpaddresStatus  from EmpDetails " +
