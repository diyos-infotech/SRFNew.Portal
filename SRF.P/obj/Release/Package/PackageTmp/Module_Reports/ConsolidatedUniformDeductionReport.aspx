<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="ConsolidatedUniformDeductionReport.aspx.cs" Inherits="SRF.P.Module_Reports.ConsolidatedUniformDeductionReport" %>
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">Uniform Deducted Details Monthly Wise</a></li>
                </ul>
            </div>
            ...
            <div class="contentarea" id="contentarea">
                <div class="dashboard_center">
                    <div class="sidebox">
                        <div class="boxhead">
                            <h2 style="text-align: center">Uniform Deducted Details Monthly Wise
                            </h2>
                        </div>
                        <div class="boxbody" style="padding: 5px 5px 5px 5px;">
                            <div class="boxin">
                                ...
                                <div class="dashboard_firsthalf" style="width: 100%">
                                    <div align="right">
                                        <asp:LinkButton ID="lbtn_Export" runat="server" OnClick="Lnkbtnexcel_Click">Export to Excel</asp:LinkButton>
                                    ...
                                    <div style="width: auto">
                                        <asp:GridView ID="GVListOfEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="UniformIssued" HeaderText="Uniform Issued" NullDisplayText="0" />
                                                <asp:BoundField DataField="UniformDeduction" HeaderText="Uniform Deducted" NullDisplayText="0" />
                                                <asp:BoundField DataField="UniformPending" HeaderText="Uniform Pending" NullDisplayText="0" />
