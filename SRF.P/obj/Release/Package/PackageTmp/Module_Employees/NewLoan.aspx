<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Employees/EmployeeMaster.Master" AutoEventWireup="true" CodeBehind="NewLoan.aspx.cs" Inherits="SRF.P.Module_Employees.NewLoan" %>
                                                        ...
                                                        <tr style="height: 32px">
                                                            ...
                                                            <td>
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" Enabled="True"
                                                                    TargetControlID="txtNewLoan" ValidChars="/0123456789"></cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 32px">
                                                            <td>Description
                                                        ...
                                                        <tr style="height: 32px">
                                                            ...
                                                            <td>
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True"
                                                                    TargetControlID="txtnoofinstall" ValidChars="0123456789"></cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 32px">
                                                        ...
                                                        <tr style="height: 32px">
                                                            ...
                                                            <td>
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FTBEloanissuedate" runat="server" Enabled="True"
                                                                    TargetControlID="txtloanissuedate" ValidChars="-/0123456789"></cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 32px">
                                                            <td>Loan No.
