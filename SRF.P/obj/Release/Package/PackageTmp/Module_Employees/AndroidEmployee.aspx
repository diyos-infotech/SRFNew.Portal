<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Employees/EmployeeMaster.Master" AutoEventWireup="true" CodeBehind="AndroidEmployee.aspx.cs" Inherits="SRF.P.Module_Employees.AndroidEmployee" %>
                                            ...
                                            <table cellpadding="5" cellspacing="5">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:RadioButton ID="rdbRejoin" runat="server" GroupName="E1" Text=" Rejoin" Visible="false" Style="padding-left: 3px" />
                                                ...
                                                <asp:Panel ID="PnlProofsSubmitted" runat="server" GroupingText="<strong>&nbsp;Proofs Submitted&nbsp;</strong>" Style="margin-top: 10px">
                                                    ...
                                                    <div class="dashboard_firsthalf" style="padding: 10px">
                                                        <table cellpadding="5" cellspacing="5">
                                                            ...
                                                            <tr runat="server">
                                                                <td style="padding-left: 18px">Front Image
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr runat="server">
                                                                <td style="padding-left: 18px">Back Image
                                                                </td>
                                                                <td>
                                                                    <asp:HyperLink ID="AadharBackImga" runat="server">
                                                                        <asp:Image ID="AadharBackImg" runat="server" Height="85" Width="85" />
                                                                    </asp:HyperLink>
                                                                </td>
                                                            </tr>
                                                            <tr runat="server">
                                                                <td>Modify Image</td>
                                                                <td>
                                                                    <asp:FileUpload ID="FileUploadAadharBackImage" runat="server" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                    ...
                                                    <div class="dashboard_secondhalf" style="padding: 10px">
                                                        <table cellpadding="5" cellspacing="5">
                                                            ...
                                                            <tr runat="server">
                                                                ...
                                                                <td>
                                                                    <asp:HyperLink ID="PancardImagea" runat="server">
                                                                        <asp:Image ID="pancardimageb" runat="server" Height="85" Width="85" />
                                                                    </asp:HyperLink>
                                                                </td>
                                                            </tr>
                                                            <tr runat="server">
                                                                <td>Modify Image</td>
                                                                <td>
                                                                    <asp:FileUpload ID="FileUploadPanimage" runat="server" />
                                                            ...
                                                            <tr runat="server">
                                                                ...
                                                                <td>
                                                                    <asp:HyperLink ID="PancardBackImagea" runat="server">
                                                                        <asp:Image ID="pancardBackimageb" runat="server" Height="85" Width="85" />
                                                                    </asp:HyperLink>
                                                                </td>
                                                            </tr>
                                                            <tr runat="server">
                                                                <td>Modify Image</td>
                                                                <td>
                                                                    <asp:FileUpload ID="FileUploadBackPanimage" runat="server" />
                                                            ...
                                                            <tr runat="server">
                                                                ...
                                                                <td>
                                                                    <asp:HyperLink ID="Bankpassimagea" runat="server">
                                                                        <div class="zoom">
                                                                            <asp:Image ID="BankpassImageb" runat="server" Height="85" Width="85" />
                                                                        </div>
                                                                    </asp:HyperLink>
                                                                </td>
                                                            </tr>
                                                            <tr runat="server">
                                                                <td>Modify Image</td>
                                                                <td>
                                                                    <asp:FileUpload ID="FileUploadBankpassImage" runat="server" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="Btn_Cancel_Personal_Tab" runat="server" Text="Cancel" OnClientClick='return confirm("Are you sure you want to Cancel this entry?");'
                                OnClick="Btn_Cancel_Personal_Tab_Click" TabIndex="33" />
                        </td>
                        <td>
