<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="InvVendorMaster.aspx.cs" Inherits="SRF.P.Module_Inventory.InvVendorMaster" %>
                                    ...
                                    <li class="right">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                            <ContentTemplate>
                                                ...
                                                <div class="rounded_corners" style="margin-left: 0px; width: 2000px; margin-right: 0px; margin-top: 15px">
