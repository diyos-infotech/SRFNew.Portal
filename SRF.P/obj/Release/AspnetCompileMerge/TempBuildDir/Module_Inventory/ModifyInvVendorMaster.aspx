<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ModifyInvVendorMaster.aspx.cs" Inherits="SRF.P.Module_Inventory.ModifyInvVendorMaster" %>
    ...
    <script type="text/javascript">
        ...
        function setProperty() {
            ...
            $(".ddlautocomplete").combobox({
                ...
                select: function (event, ui) { $("#<%=ddlVendorID.ClientID %>").attr("data-clientId", ui.item.value); OnAutoCompleteDDLVendoridchange(event, ui); },
            select: function (event, ui) { $("#<%=ddlVendorName.ClientID %>").attr("data-clientId", ui.item.value); OnAutoCompleteDDLVendornamechange(event, ui); },
