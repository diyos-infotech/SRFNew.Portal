<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="POReport.aspx.cs" Inherits="SRF.P.Module_Inventory.POReport" %>
    ...
    <script type="text/javascript">
        ...
        function setProperty() {
            ...
            $(".ddlautocomplete").combobox({
                select: function (event, ui) { $("#<%=ddlPONo.ClientID %>").attr("data-clientId", ui.item.value); OnAutoCompleteDDLPONochange(event, ui); },
