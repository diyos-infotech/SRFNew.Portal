<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="PaySheetWagesReport.aspx.cs" Inherits="SRF.P.Module_Reports.PaySheetWagesReport" %>
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">Paysheet Wages
                        Report</a></li>
                </ul>
            </div>
            ...
            <div class="contentarea" id="contentarea">
                <div class="dashboard_center">
                    <div class="sidebox">
                        <div class="boxhead">
                            <h2 style="text-align: center">Paysheet Wages Report
                            </h2>
                        </div>
                                ...
                                <div class="dashboard_firsthalf" style="width: 100%">
                                    <table width="100%" cellpadding="5" cellspacing="5">
                                        <tr>
                                            ...
                                            <td style="width: 40%">&nbsp;<asp:Button runat="server" ID="btn_Submit" Text="Submit" class="btn save" OnClick="btnsearch_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5">
