<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="EmpIDCard.aspx.cs" Inherits="SRF.P.Module_Reports.EmpIDCard" %>
                        ...
                        <div style="padding: 5px 5px 5px 5px;">
                            <div>
                                ...
                                <table style="margin-top: 8px; margin-bottom: 8px" width="80%">
                                    ...
                                    <tr>
                                        <td style="font-weight: bold; width: 120px">Employee ID / Name:
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <asp:Button ID="Button1" runat="server" Text="Download" OnClick="BtnIDCardNew_Click" />
