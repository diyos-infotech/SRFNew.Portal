<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="PFReports.aspx.cs" Inherits="SRF.P.Module_Reports.PFReports" %>
                                    ...
                                    <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="PFNo">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblepfno" Text="<%# Bind('EmpEpfNo') %>"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="DOB">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lbldob" Text='<%# Eval("EmpDtofBirth") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="Grosswages" HeaderText="Gross Wages" DataFormatString="{0:0.00}" />
                                            <asp:BoundField DataField="OTwages" HeaderText="OT Wages" DataFormatString="{0:0.00}" />
