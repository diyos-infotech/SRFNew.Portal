<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="POInFlowDetailsReport.aspx.cs" Inherits="SRF.P.Module_Inventory.POInFlowDetailsReport" %>
                                    ...
                                    <asp:GridView ID="GVPOInFlowDetails" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="VATCmp1" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPOVATCmp1" runat="server" Text='<%#Bind("PoVATCmp1","{0:0.##}") %>' Width="90px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblPOTotalVATCmp1" Style="font-weight: bold; text-align: center"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="VATCmp2" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPOVATCmp2" runat="server" Text='<%#Bind("PoVATCmp2","{0:0.##}") %>' Width="90px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblPOTotalVATCmp2" Style="font-weight: bold; text-align: center"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="VATCmp3" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPOVATCmp3" runat="server" Text='<%#Bind("PoVATCmp3","{0:0.##}") %>' Width="90px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblPOTotalVATCmp3" Style="font-weight: bold; text-align: center"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="VATCmp4" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPOVATCmp4" runat="server" Text='<%#Bind("PoVATCmp4","{0:0.##}") %>' Width="90px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblPOTotalVATCmp4" Style="font-weight: bold; text-align: center"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="VATCmp5" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPOVATCmp5" runat="server" Text='<%#Bind("PoVATCmp5","{0:0.##}") %>' Width="90px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblPOTotalVATCmp5" Style="font-weight: bold; text-align: center"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="VATCmp1" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblINVATCmp1" runat="server" Text='<%#Bind("InVATCmp1","{0:0.##}") %>' Width="90px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblINTotalVATCmp1" Style="font-weight: bold; text-align: center"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="VATCmp2" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblINVATCmp2" runat="server" Text='<%#Bind("InVATCmp2","{0:0.##}") %>' Width="90px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblINTotalVATCmp2" Style="font-weight: bold; text-align: center"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="VATCmp3" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblINVATCmp3" runat="server" Text='<%#Bind("InVATCmp3","{0:0.##}") %>' Width="90px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblINTotalVATCmp3" Style="font-weight: bold; text-align: center"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="VATCmp4" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblINVATCmp4" runat="server" Text='<%#Bind("InVATCmp4","{0:0.##}") %>' Width="90px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblINTotalVATCmp4" Style="font-weight: bold; text-align: center"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="VATCmp5" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblINVATCmp5" runat="server" Text='<%#Bind("InVATCmp5","{0:0.##}") %>' Width="90px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblINTotalVATCmp5" Style="font-weight: bold; text-align: center"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
