<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ModifyInflowDetails.aspx.cs" Inherits="SRF.P.Module_Inventory.ModifyInflowDetails" %>
    ...
    <script type="text/javascript">
        ...
        function setProperty() {
            ...
            $(".ddlautocomplete").combobox({
                ...
                select: function (event, ui) { $("#<%=ddlInflowID.ClientID %>").attr("data-clientId", ui.item.value); OnAutoCompleteDDLInfowIDchange(event, ui); },
