<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Clients/Clients.master" AutoEventWireup="true" CodeBehind="NewManualBill.aspx.cs" Inherits="SRF.P.Module_Clients.NewManualBill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div id="content-holder">
        <div class="content-holder">
            <h1 class="dashboard_heading">Manual Billing</h1>
            <div class="contentarea" id="contentarea">
                <div class="dashboard_full">
                    <div class="sidebox">
                        <div class="boxhead">
                            <h2 style="text-align: center">Manual Billing</h2>
                        </div>
                            ...
                            <div class="boxin">
                                ...
                                <table width="98%" cellpadding="5" cellspacing="5">
                                    ...
                                    <tr>
                                        <td>Type</td>
                                        <td>
                                            <asp:DropDownList ID="ddltype" Width="150px" runat="server" CssClass="sdrop">
                                        ...
                                        <td width="30%">Manual Billing Bill No's
                                        </td>
                                        <td>
                                             ...
                                             <asp:LinkButton runat="server" ID="Delete" Text="Delete" CommandArgument='<%# Bind("Designation") %>' CommandName="Delete"  OnClientClick="return confirm('Are you sure you want to Delete this Record?');"
                                                 class="linkbuttons"></asp:LinkButton>
                                                    ...
                                                    <asp:TemplateField HeaderText="Sl.No">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="lblgvSlno" runat="server" Text="<%#Container.DataItemIndex+1 %>" Width="50px"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                        ...
                                        <tr>
                                            <td align="right" valign="top">
                                                <table width="60%" cellpadding="5" cellspacing="5">
                                                    <tr>
                                                        <td style="position: relative; left: -350px">Remarks :
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td width="80%" style="text-align: right">
                                                            ...
                                                            <asp:TextBox ID="TxtCGSTPrc" Text="" Visible="false" runat="server" Width="40px"></asp:TextBox>

                                                        </td>
                                                        <td width="20%" style="text-align: right">
                                                            <asp:TextBox ID="lblCGST" Text="" Visible="false" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="80%" style="text-align: right">
                                                            ...
                                                            <asp:TextBox ID="TxtSGSTPrc" Text="" Visible="false" runat="server" Width="40px"></asp:TextBox>

                                                        </td>
                                                        <td width="20%" style="text-align: right">
                                                            <asp:TextBox ID="lblSGST" Text="" Visible="false" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="80%" style="text-align: right">
                                                            ...
                                                            <asp:TextBox ID="TxtIGSTPrc" Text="" Visible="false" runat="server" Width="40px"></asp:TextBox>

                                                        </td>
                                                        <td width="20%" style="text-align: right">
                                                            <asp:TextBox ID="lblIGST" Text="" Visible="false" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <asp:Button ID="btninvoice" runat="server" Text="Tax Invoice" class="btn save" OnClick="btninvoice_Click" Visible="false" />
