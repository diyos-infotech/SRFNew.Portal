<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="InvModifyPODetails.aspx.cs" Inherits="SRF.P.Module_Inventory.InvModifyPODetails" %>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="100%" cellpadding="5" cellspacing="5" style="margin: 10px">
                                                                ...
                                                                <tr style="height: 36px">
                                                                    <td>
                                                                        <asp:Label ID="lblmonth" runat="server" Text="Month" Visible="false"></asp:Label></td>
