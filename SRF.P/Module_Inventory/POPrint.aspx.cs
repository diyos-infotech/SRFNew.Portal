    ...
    public partial class POPrint : System.Web.UI.Page
    {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dttotals = config.ExecuteReaderWithQueryAsync(strQry1).Result;
                ...
                cell.Colspan = 2;
                Maintable2.AddCell(cell);
                cell = new PdfPCell(new Paragraph(tottal.ToString("#.##"), FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 2; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0.5f;
                cell.BorderWidthTop = 0.5f;
                cell.BorderWidthLeft = 0;
                ...
                cell.Colspan = 6;
                Maintable2.AddCell(cell);
                cell = new PdfPCell(new Paragraph("Payment will be made within 45 days from reciept of the materials,Above mentioned Price does not include GST amount Please submit the Original invoice Including GST with the acknowledged DC at the office within 3 days from delivery,Payment will be made by cheque of RTGS", FontFactory.GetFont(FontStyle, 10, Font.NORMAL, BaseColor.BLACK)));
