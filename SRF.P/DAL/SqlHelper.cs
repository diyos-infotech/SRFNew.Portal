...
namespace KLTS.Data
{
    ...
    public class GlobalData
    {
        ...
        public string GetBillPrefix(bool WithST)
        {
            string billPrefix = "";
            if (WithST)
            {
                if (System.Configuration.ConfigurationManager.AppSettings["BillPrefixWST"] != null)
                {
                    string pref = System.Configuration.ConfigurationManager.AppSettings["BillPrefixWST"].ToString();
                    if (pref.Length > 0)
                        billPrefix = pref;
                }
            }
            ...
            {
                if (System.Configuration.ConfigurationManager.AppSettings["BillPrefixWOST"] != null)
                {
                    string pref = System.Configuration.ConfigurationManager.AppSettings["BillPrefixWOST"].ToString();
                    if (pref.Length > 0)
                        billPrefix = pref;
                }
            }
        ...
        public bool Checkdesignation(string desgn)
        {
            ...
            System.Data.DataTable dt = config.ExecuteReaderWithQueryAsync(Sqlqry).Result;
            if (dt.Rows.Count > 0)
            {
                return true;
            }
        ...
        public string LoadMaxEmpid(string EmpidPrefix, string EmployeeType)
        {
            ...
            System.Data.DataTable dtForEmpid = config.ExecuteReaderWithQueryAsync(SqlqryForEmpid).Result;
            int Empid = 1;
        ...
        public string LoadMaxClientid(string Clientidprefix)
        {
            ...
            System.Data.DataTable dtCId = config.ExecuteReaderWithQueryAsync(SqlqryForCId).Result;
            int CId = 1;
        ...
        public DataTable LoadZoneOnUserID(string Zone)
        {
            List<string> list = Zone.Split(',').ToList();
            DataTable dtZone = new DataTable();
            dtZone.Columns.Add("Zone");
            if (list.Count != 0)
            {
                foreach (string s in list)
                {
                    DataRow row = dtZone.NewRow();
                    row["Zone"] = s;
                    dtZone.Rows.Add(row);
                }
            }
        ...
        public DataTable LoadEmpIds(string EmpIdPrefix)
        {
            ...
            // System.Data.DataTable DtEmpIds = SqlHelper.Instance.ExecuteSPWithoutParams(ProcedureName);
            System.Data.DataTable DtEmpIds = config.ExecuteAdaptorAsyncWithParams(ProcedureName, HtEmpids).Result;

            return DtEmpIds;
        }

        public DataTable LoadEmpNames(string EmpIdPrefix)
        {
        ...
        {
            string ProcedureName = "ActiveClients";
        ...
        public DataTable LoadCIds(string ClientIdPrefix)
        {
        ...
        public DataTable LoadCNames(string ClientIdPrefix)
        {
        ...
        public DataTable LoadOpManagerIds()
        {
            ...
            System.Data.DataTable DtEmpIds = config.ExecuteReaderWithQueryAsync(Sqlqry).Result;
            return DtEmpIds;
        }
        ...
        public DataTable LoadOpManagerNames()
        {
            ...
            System.Data.DataTable DtEmpNames = config.ExecuteReaderWithQueryAsync(Sqlqry).Result;
            return DtEmpNames;
        }
        ...
        public DataTable LoadGSTNumbers()
        {
            string ProcedureName = "GetGSTNos";
            System.Data.DataTable DtGSTNos = config.ExecuteReaderWithSPAsync(ProcedureName).Result;
            return DtGSTNos;
        }
        ...
        public DataTable LoadActiveEmployees(string EmpidPrefix)
        {
            ...
            // System.Data.DataTable DtActiveEmployees = SqlHelper.Instance.ExecuteSPWithoutParams(ProcedureName);
        ...
        public DataTable LoadActiveEmployeesOrderBy(string EmpidPrefix, int OrderBy)
        {
        ...
        public DataTable LoadExpensesVoucherNos(int OperationType)
        {
            ...
            System.Data.DataTable DtSegments = config.ExecuteAdaptorAsyncWithParams(ProcedureName, HtActiveEmployees).Result;
            return DtSegments;
        }
        ...
        public DataTable LoadArea()
        {
            ...
            string ProcedureName = "GetArea";
            System.Data.DataTable DtArea = config.ExecuteReaderWithSPAsync(ProcedureName).Result;
            return DtArea;

        }

        public DataTable LoadZone()
        {

            string ProcedureName = "GetZone";
            System.Data.DataTable DtZone = config.ExecuteReaderWithSPAsync(ProcedureName).Result;
            return DtZone;
    ...
    public class Timings
    {
        ...
        public int GetNoofDaysForEnteredMonth(DateTime date, int bBillDates)
        {
            ...
            {
                //code modified by swathi as on 22-4-2017 if 26-25 / 21-20 then prevmonth val
                if (Monthdays.Month == 1)
                {
                    days = DateTime.DaysInMonth(Monthdays.Year, 12);
