...
namespace SRF.P.Module_Settings
{
    public partial class CreateLoginPocketFame : System.Web.UI.Page
    {
        ...
        string BranchID = "";
        string companyid = "";
        //page changes done by Mahesh Goud on 2022-06-28
        ...
        public void GetData()
        {
            ...
            string ChkQry = "select * from Logindetails_Android where companyid='"+ companyid + "' and EmpId='" + txtEmpid.Text + "' ";
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (result > 0)
            {
                ...
                if (chkresult.Rows.Count > 0)
                {
                    string updatequery = "Update Logindetails_Android set UserName='" + txtusrname.Text.Trim() + "',Password='" + txtConfirmPassword.Text.Trim() + "',UpdatedDateTime=getdate(),Role='" + ddlrole.SelectedValue + "' where empid='" + Empid + "' and companyid='" + companyid + "'";
                ...
                {
                    string insertquery = "insert into Logindetails_Android (Id,	EmpId,	UserName,	Password,	CompanyId,	CreatedDateTime	,UpdatedDateTime,	EmailId	,Role,	PushCode,	Rated	,ClientId) values (newid(),'" + txtEmpid.Text + "','" + txtusrname.Text.Trim() + "','" + txtConfirmPassword.Text.Trim() + "','" + companyid + "',Getdate(),'','','" + ddlrole.SelectedValue + "','',0,'')";
