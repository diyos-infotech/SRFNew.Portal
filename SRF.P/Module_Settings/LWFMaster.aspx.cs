...
namespace SRF.P
{
    public partial class LWFMaster : System.Web.UI.Page
    {
        ...
        protected void DdlStates_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string GetQry = "Select convert(nvarchar(10),fromdate,103) as fromdateval,convert(nvarchar(10),todate,103) as todateval,* from LWFMaster where State='" + DdlStates.SelectedValue + "'";
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                txtFromDate.Text= Dt.Rows[0]["Fromdateval"].ToString();
                txtToDate.Text = Dt.Rows[0]["Todateval"].ToString();
            }
        }
