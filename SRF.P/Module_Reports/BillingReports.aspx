<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="BillingReports.aspx.cs" Inherits="SRF.P.Module_Reports.BillingReports" %>
                                ...
                                <div id="forExport" style="overflow: scroll; width: 960px;">
                                    <asp:GridView ID="GVInvoiceBills" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Round Off" ItemStyle-Width="125px">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblRoundOff" Text='<%#Bind("Roundoff") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
