...
namespace SRF.P.Module_Reports
{
    public partial class ClentwiseEmployeesSalaryreports : System.Web.UI.Page
    {
        ...
        protected void LoadClientNames()
        {
            ...
            DataTable dtable = config.ExecuteReaderWithQueryAsync(selectquery).Result;
        ...
        protected void Fillpfandesidetails()
        {
            ...
            for (int i = 0; i < GVListEmployees.Rows.Count; i++)
            {
                ...
                DataTable dtempname = config.ExecuteReaderWithQueryAsync(Sqlqry).Result;
                ...
                DataTable dtemprpfandesi = config.ExecuteReaderWithQueryAsync(sqlqryforemprpfesi).Result;
                ...
                DataTable dtforpfesinos = config.ExecuteReaderWithQueryAsync(sqlqryforesipfacno).Result;
