...
namespace SRF.P.Module_Reports
{
    public partial class EmployeeForms : System.Web.UI.Page
    {
        ...
        protected void btnPoliceVfctn_Click(object sender, EventArgs e)
        {
            ...
            Font FontStyle4 = FontFactory.GetFont("Tahoma", BaseFont.CP1252, BaseFont.EMBEDDED, 10, Font.BOLD, BaseColor.BLACK);
            ...
            if (dtEmpdetails.Rows.Count > 0)
            {
                ...
                //PrAdress= dtEmpdetails.Rows[0]["prPincode"].ToString();
            ...
            try
            {
                ...
                cell1 = new PdfPCell(new Phrase("Application for Police Verification", FontStyle2));
                ...
                cell1 = new PdfPCell(new Phrase("The Commissioner of Police / Superintendent of Police / SHO", FontStyle3));
                cell1.HorizontalAlignment = 0;
                cell1.Colspan = 3;
                cell1.Border = 0;
                cell1.PaddingTop = 10;
                ...
                cell1 = new PdfPCell(new Phrase("________________________City / District / Police Station.", FontStyle3));
                cell1.HorizontalAlignment = 0;
                cell1.Colspan = 3;
                cell1.Border = 0;
                temptable1.AddCell(cell1);

                cell1 = new PdfPCell(new Phrase("Karnataka.", FontStyle3));
                cell1.HorizontalAlignment = 0;
                cell1.Colspan = 3;
                cell1.Border = 0;
                temptable1.AddCell(cell1);

                cell1 = new PdfPCell(new Phrase("Sir,", FontStyle3));
                cell1.HorizontalAlignment = 0;
                cell1.Colspan = 3;
                cell1.PaddingTop = 10;
                cell1.Border = 0;
                ...
                cell1 = new PdfPCell(new Phrase("Sub: - Request to issue Police - Verification / Clearance Certificate\nfor the Purpose of.", FontStyle3));
                cell1.HorizontalAlignment = 0;
                cell1.Colspan = 3;
                cell1.Border = 0;
                cell1.PaddingTop = 10;
                ...
                float[] width1 = new float[] { 1f, 5f, 3f, 2f };
                ...
                cell1 = new PdfPCell(new Phrase("Select appropriate Certificate required", FontStyle2));
                cell1.HorizontalAlignment = 0;
                cell1.Colspan = 1;
                table1.AddCell(cell1);
                ...
                cell1 = new PdfPCell(new Phrase("Verification and comparison of Finger Print", FontStyle3));
                cell1.HorizontalAlignment = 1;
                cell1.Colspan = 1;
                table1.AddCell(cell1);
                ...
                float[] width3 = new float[] { 1f, 3f, 9f };
                ...
                float[] width4 = new float[] { 1f, 2f, 2f, 1f, 2f, 2f };
                ...
                float[] width5 = new float[] { 1f, 3f, 9f };
                ...
                cell5 = new PdfPCell(new Phrase("Present Address", FontStyle4));
                cell5.HorizontalAlignment = 0;
                cell5.Colspan = 1;
                cell5.Border = 0;
                cell3.PaddingBottom = 20;
                table5.AddCell(cell5);
                ...
                cell5 = new PdfPCell(new Phrase(Address1.Trim(), FontStyle3));
                cell5.HorizontalAlignment = 0;
                cell5.Colspan = 1;
                cell5.Border = 0;
                table5.AddCell(cell5);
                ...
                cell5 = new PdfPCell(new Phrase("a. Period of stay", FontStyle4));
                cell5.HorizontalAlignment = 0;
                cell5.Colspan = 3;
                cell5.Border = 0;
                cell5.PaddingLeft = 40;
                table5.AddCell(cell5);
                ...
                cell5 = new PdfPCell(new Phrase("Permanent Address", FontStyle4));
                cell5.HorizontalAlignment = 0;
                cell5.Colspan = 1;
                cell5.Border = 0;
                cell5.PaddingBottom = 50;
                ...
                cell5 = new PdfPCell(new Phrase(Address2.Trim(), FontStyle3));
                cell5.HorizontalAlignment = 0;
                cell5.Colspan = 1;
                cell5.Border = 0;
                table5.AddCell(cell5);
                ...
                cell5 = new PdfPCell(new Phrase("7", FontStyle4));
                cell5.HorizontalAlignment = 0;
                cell5.Colspan = 1;
                cell5.Border = 0;
                //cell5.PaddingTop = 50;
                ...
                float[] width6 = new float[] { 1f, 3f, 1f, 1f };
                ...
                cell6 = new PdfPCell(new Phrase("Original Challan has to be enclosed", FontStyle2));
                cell6.HorizontalAlignment = 0;
                cell6.Colspan = 4;
                ...
                cell6 = new PdfPCell(new Phrase("11.", FontStyle4));
                cell6.HorizontalAlignment = 0;
                cell6.Colspan = 1;
                cell6.Border = 0;
                cell6.PaddingTop = 20;
                ...
                cell6 = new PdfPCell(new Phrase("Do you possess a passport         ", FontStyle4));
                cell6.HorizontalAlignment = 0;
                cell6.Colspan = 1;
                cell6.Border = 0;
                cell6.PaddingLeft = -38;
                ...
                cell6 = new PdfPCell(new Phrase("Yes", FontStyle3));
                cell6.HorizontalAlignment = 0;
                cell6.Colspan = 1;
                cell6.Border = 0;
                cell6.PaddingTop = 20;
                ...
                cell6 = new PdfPCell(new Phrase("No", FontStyle3));
                cell6.HorizontalAlignment = 0;
                cell6.Colspan = 1;
                cell6.Border = 0;
                ...
                cell6 = new PdfPCell(new Phrase("a. Passport Number", FontStyle3));
                cell6.HorizontalAlignment = 0;
                cell6.Colspan = 4;
                //cell6.PaddingRight = 30;
                cell6.Border = 0;
                ...
                cell6 = new PdfPCell(new Phrase("b. Date of issue", FontStyle3));
                cell6.HorizontalAlignment = 0;
                cell6.Colspan = 4;
                //cell6.PaddingRight = 30;
                cell6.Border = 0;
                ...
                cell6 = new PdfPCell(new Phrase("c. Validity", FontStyle3));
                cell6.HorizontalAlignment = 0;
                cell6.Colspan = 4;
                //cell6.PaddingRight = 30;
                cell6.Border = 0;
                ...
                cell6 = new PdfPCell(new Phrase("d. Place of issue", FontStyle3));
                cell6.HorizontalAlignment = 0;
                cell6.Colspan = 4;
                //cell6.PaddingRight = 40;
                cell6.Border = 0;
                cell6.PaddingBottom = 30;
                table6.AddCell(cell6);
        ...
        protected void btnform5_Click(object sender, EventArgs e)
        {
            ...
            string query = "Select epf.empepfno,(ed.empfname+''+ed.empmname+''+ed.emplname) as empname,ed.empfathername,case ed.sex when 'M' then 'Male' when 'F' then 'Female' else Transgender end Sex,case convert(varchar(10),ed.empdtofjoining,103) when '01/01/1900' then '' else convert(varchar(10),ed.empdtofjoining,103) end empdtofjoining,ed.empremarks from empdetails left join empepfcodes epf on epf.empid=ed.empid where ed.empdtofjoining WHERE MONTH(EmpDtofJoining)=6 AND YEAR(EmpDtofJoining)=2015   ";
            ...
            PdfPCell nameaddress = new PdfPCell(new Phrase("Name and address of the Factory / Est.:" + CompanyAddress, FontFactory.GetFont(FontFactory.TIMES_ROMAN, 10, Font.NORMAL, BaseColor.BLACK)));
            nameaddress.HorizontalAlignment = 0;
            nameaddress.Colspan = 11;
            nameaddress.Border = 0;
            tablenewc.AddCell(nameaddress);

            PdfPCell cellcode = new PdfPCell(new Phrase("Code No. of the Factory / Est.:" + cmpnypfno, FontFactory.GetFont(FontFactory.TIMES_ROMAN, 10, Font.NORMAL, BaseColor.BLACK)));
        ...
        protected void btnformsXIV_Click(object sender, EventArgs e)
        {
            ...
            #region Begin  Call Stored Procedure
            dt = config.ExecuteAdaptorAsyncWithParams(SPName, HTEmpBiodata).Result;
            #endregion  End  Call Stored Procedure
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                // for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    Wagerate = Convert.ToSingle(dt.Rows[0]["Wagerate"].ToString());
                    ...
                    cellSERVICE.Colspan = 4;
                    cellSERVICE.Border = 0;
                    cellSERVICE.PaddingTop = 20;
                    tble.AddCell(cellSERVICE);



                    PdfPCell cellrule = new PdfPCell(new Phrase("(See Rule 76)", FontFactory.GetFont(FontStyle, Fontsize, Font.NORMAL, BaseColor.BLACK)));
                    cellrule.HorizontalAlignment = 1;
                    cellrule.Colspan = 4;
                    cellrule.Border = 0;
                    tble.AddCell(cellrule);

                    PdfPCell cellrule2 = new PdfPCell(new Phrase("(Under Contract Labour Act, 1971)", FontFactory.GetFont(FontStyle, Fontsize, Font.NORMAL, BaseColor.BLACK)));
                    cellrule2.HorizontalAlignment = 1;
                    cellrule2.Colspan = 4;
                    cellrule2.Border = 0;
                    tble.AddCell(cellrule2);
                    ...
                    PdfPCell cellestablishment = new PdfPCell(new Phrase("\nName & Address of the Est. to/under which contract is carried on", FontFactory.GetFont(FontStyle, Fontsize, Font.BOLD, BaseColor.BLACK)));
                    ...
                    PdfPCell cellempty15 = new PdfPCell(new Phrase("\nName and address of Principal Employer", FontFactory.GetFont(FontStyle, Fontsize, Font.BOLD, BaseColor.BLACK)));
                    cellempty15.HorizontalAlignment = 0;
                    cellempty15.Colspan = 4;
                    tble.AddCell(cellempty15);

                    PdfPCell celltypeofwork = new PdfPCell(new Phrase("Security Services", FontFactory.GetFont(FontStyle, Fontsize, Font.NORMAL, BaseColor.BLACK)));
                    celltypeofwork.HorizontalAlignment = 0;
                    celltypeofwork.BorderWidthLeft = 0.2f;
                    celltypeofwork.BorderWidthRight = 0.2f;
                    celltypeofwork.BorderWidthTop = 0;
                    celltypeofwork.BorderWidthBottom = 0;
                    celltypeofwork.Colspan = 4;
                    tble.AddCell(celltypeofwork);

                    PdfPCell cellprincipal = new PdfPCell(new Phrase(Clientname + "\n" + addressData, FontFactory.GetFont(FontStyle, Fontsize, Font.NORMAL, BaseColor.BLACK)));
                    cellprincipal.HorizontalAlignment = 0;
                    cellprincipal.BorderWidthLeft = 0.2f;
                    cellprincipal.BorderWidthRight = 0.2f;
                    cellprincipal.BorderWidthTop = 0;
                    cellprincipal.BorderWidthBottom = 0;
                    cellprincipal.Colspan = 4;
                    //cellspaces1.Border = 0;
                    tble.AddCell(cellprincipal);
                    ...
                    PdfPCell cellempty13s = new PdfPCell(new Phrase("\n" + Empid, FontFactory.GetFont(FontStyle, Fontsize, Font.NORMAL, BaseColor.BLACK)));
                    ...
                    PdfPCell cellempty12S = new PdfPCell(new Phrase(" " + dt.Rows[0]["Designation"].ToString(), FontFactory.GetFont(FontStyle, Fontsize, Font.NORMAL, BaseColor.BLACK)));
                    ...
                    PdfPCell cellempty11s = new PdfPCell(new Phrase("\n" + dt.Rows[0]["DtOfJoining"].ToString(), FontFactory.GetFont(FontStyle, Fontsize, Font.NORMAL, BaseColor.BLACK)));
