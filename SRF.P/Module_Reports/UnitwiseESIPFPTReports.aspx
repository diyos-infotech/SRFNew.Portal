<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="UnitwiseESIPFPTReports.aspx.cs" Inherits="SRF.P.Module_Reports.UnitwiseESIPFPTReports" %>
                                    ...
                                    <div style="overflow: scroll; width: auto">
                                        <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ESIonDuties" HeaderText="EmpESIAmt" DataFormatString="{0:0.00}" />
                                                ...
                                                <asp:BoundField DataField="ESI" HeaderText="EmpConsESIAmt" DataFormatString="{0:0.00}" />
