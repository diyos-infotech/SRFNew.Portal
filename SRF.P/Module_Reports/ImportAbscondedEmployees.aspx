<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="ImportAbscondedEmployees.aspx.cs" Inherits="SRF.P.Module_Reports.ImportAbscondedEmployees" %>
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="ImportAbscondedEmployees.aspx" style="z-index: 7;" class="active_bread">Import Absconding Employees</a></li>
                </ul>
            </div>
                            ...
                            <div class="boxin">
                                ...
                                <div id="right_content_area" style="text-align: left; font: Tahoma; font-size: small; font-weight: normal">
                                    ...
                                    <div class="dashboard_firsthalf" style="width: 100%">
                                        ...
                                        <td>
                                            <asp:FileUpload ID="FlUploadDtofLeaving" runat="server" />
                                        </td>
                                                <td>
