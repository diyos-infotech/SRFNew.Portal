<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="LoanDetailsMonthlywise.aspx.cs" Inherits="SRF.P.Module_Reports.LoanDetailsMonthlywise" %>
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">Loan Details Monthly Wise</a></li>
                </ul>
            </div>
                                        ...
                                        <div style="width: auto">
                                            <asp:GridView ID="GVListOfEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                                ...
                                                <Columns>
                                                     ...
                                                     <asp:BoundField DataField="3" HeaderText="Other Ded" nulldisplaytext="0"  />
                                                     <asp:BoundField DataField="4" HeaderText="Room Rent" nulldisplaytext="0" />
